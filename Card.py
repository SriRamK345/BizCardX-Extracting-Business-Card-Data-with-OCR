...
if selected == 'Home':
    ...
    st.markdown(
        "### :rainbow[Technologies used :]  Python, easyOCR, MySQL, pandas, Streamlit.")
    st.markdown(
    ...
    if uploaded_file != None:
        ...
        with col1:
            ...
            if a:
                cursor.execute("""INSERT INTO business_cards (name, designation, company, email, website, primary_no, secondary_no,address, pincode) 
